...
The "non-polymorphic" checkbox indicates whether to use non-polymorphic data in the sequences.
If true, constant-sites in the data will be used as part of the likelihood calculation. 
If false (the default) constant sites will be removed from the sequence data and a normalization 
factor is calculated for the likelihood.
